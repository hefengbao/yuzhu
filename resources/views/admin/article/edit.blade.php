...
@section('header')编辑文章@endsection
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea name="excerpt" id="excerpt" cols="30" rows="3" class="form-control" aria-describedby="excerptHelp" placeholder="（可选）">{{ old('excerpt', $article->excerpt) }}</textarea>

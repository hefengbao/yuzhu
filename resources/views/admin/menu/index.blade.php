...
@section('content')
    <div class="row">
        <div class="col-md-5">
            <div class="card">
                <div class="card-header">编辑菜单</div>
                <div class="card-body">
                                ...
                                <div class="box-body">
                                    <ul class="list-unstyled" id="category_list">
                                        @foreach($categories as $category)
                                            <li><input type="checkbox" value="category_{{ $category->id }}"
                                                       name="categories"> <span>{{ $category->category_name }}</span>
                                            </li>
                                        @endforeach
                                    </ul>
                                </div>
                                ...
                                <div class="box-body">
                                    <ul class="list-unstyled" id="page_list">
                                        @foreach($pages as $page)
                                            <li><input type="checkbox" value="page_{{ $page->id }}" name="pages">
                                                <span>{{ $page->post_title }}</span></li>
                                        @endforeach
                                    </ul>
                                </div>
                                <div class="box-footer">

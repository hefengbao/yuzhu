                ...
                <div class="box-body">
                    <form action="{{ route('category.store') }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="tag_name" name="category_name" class="form-control" placeholder="名称"
                                   required>
                        </div>
                        <p>这将是它在站点上显示的名字。</p>
                        <div class="form-group">
                            <label for="" class="control-label">别名 <sup>*</sup></label>
                            <input type="text" id="tag_slug" name="category_slug" class="form-control" placeholder="别名"
                                   required>
                        </div>

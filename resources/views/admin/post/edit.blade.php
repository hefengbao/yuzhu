...
<div class="row">
    ...
    <form method="POST" action="{{ route('post.update', $post->id) }}" accept-charset="UTF-8" id="topic-create-form">
            ...
            <div class="box box-danger">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <input id="post_title" type="text" class="form-control" name="post_title" placeholder="标题" value="{{ $post->post_title }}" required>
                        </div>
                        <div class="form-group">
                                <label for="post_slug" class="control-label">链接 <sup>*</sup></label>
                                <input id="post_slug" type="text" class="form-control" name="post_slug" placeholder="链接" value="{{ $post->post_slug }}" required>
                        </div>
                        <div class="form-group">
            ...
            <div class="box box-warning">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="post_excerpt" name="post_excerpt" class="form-control" rows="5" placeholder="200字以内" >{{ !isset($post)? '':$post->post_excerpt }}</textarea>
                    </div>
                    <div class="form-group">

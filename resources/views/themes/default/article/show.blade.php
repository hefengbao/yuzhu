        ...
        <div class="col-md-12">
            <div class="p-4 mb-2 bg-light rounded">
                <div style="display: flex">
                    <div class="avatar">
                        <img class="avatar-rounded img-fluid" src="{{ $article->author->avatar ? Storage::disk('public')->url($article->author->avatar) : Avatar::create($article->author->name)->setBackground('#adb5bd')->toBase64() }}" alt="">
                    </div>

...
<head>
    ...
    <meta name="description" content="@if(if_route('home.index')){{ $options->autoload()['description'] ?? '' }}@else @yield('description') @endif">
...
<header>
    <nav>
        ...
        <ul>
            ...
            <li>
                <a href="#" data-theme-switcher="dark" class="theme-toggle" title="Toggle theme" aria-label="Toggle theme">
                    <svg
...
<footer>
    <hr>
    <p>Powered by <a href="https://hefengbao.github.io/yuzhu/" class="link-secondary" target="_blank">Yuzhu</a>@if($icp = $options->autoload()['icp']) · <a href="https://beian.miit.gov.cn/" target="_blank">{{ $icp }}</a>@endif</p>
</footer>

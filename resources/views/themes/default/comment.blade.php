            ...
            @if($comment->parent && $comment->parent->status == \App\Constant\CommentStatus::Approved)
                <div style="margin:32px;">
                    <blockquote>
                        ...
                        {!! \Illuminate\Support\Str::markdown($comment->parent->body) !!}
                    </blockquote>
                </div>
            @endif
